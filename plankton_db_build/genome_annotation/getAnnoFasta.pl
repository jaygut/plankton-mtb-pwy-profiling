#!/data/gent/vo/001/gvo00125/vsc43582/Software/annotation/bin/perl 
#
# getAnnoFast.pl
...
#
# Code underwent minor adaptations w.r.t. original script: Mario Stanke, 10.05.2007, last modification by Katharina J. Hoff on Feb 21st 2018
#
